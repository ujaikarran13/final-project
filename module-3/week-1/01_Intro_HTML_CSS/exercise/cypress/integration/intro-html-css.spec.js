...
describe('Part 1: Fan page', () => {
    ...
    describe('Table section', () => {
        ...
        it('Inside "facts-section", your page must have a second-level heading describing its contents. The heading must be a child of the section.', () => {
    ...
    describe('Quotes section', () => {
        ...
        it('Inside "quotes-section", your page must have a second-level heading describing its contents. The heading must be a child of the section.', () => {
    ...
    describe('Links section', () => {
        ...
        it('Inside "links-section", your page must have a second-level heading describing its contents. The heading must be a child of the section.', () => {
