...
public class AssessmentPart1 {
	...
	*/
	public int Q03_moviePrice(int age) {
		int generalAdmissionTicket = 12;
		int childrenTicket = 7;
		if (age <= 12) {
			return childrenTicket;
		} else {
			return generalAdmissionTicket;
		}
	...
	*/
	public int Q04_moviePriceMatinee(int age, boolean isBefore5pm, boolean isWeekend) {
		...
		int childrenTicket = 7;
		int matineeTicket = 8;
		int childrenMatineeTicket = 5;
	 if (age <=12 && isBefore5pm && !isWeekend){
		 return childrenMatineeTicket;
	 } else if (age > 12 && isBefore5pm && !isWeekend){
	...
	*/
	public String Q06_firstNCharacters(String originalString, int numCharacters) {
		...
		if (numCharacters <=3) {
			return originalString.substring(0, 2);
	...
	*/
	public Map<String, Integer> Q11_mealCount(String[] mealOrders) {
		...
		mealCount.put("Beef:", 1);
		mealCount.put("Chicken:", 1);
		mealCount.put("Fish:", 2);
		mealCount.put("Tofu:", 2);
