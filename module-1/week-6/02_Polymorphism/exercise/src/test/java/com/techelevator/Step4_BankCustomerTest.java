...
public class Step4_BankCustomerTest {
    ...
    private Object createListOfAccountables(boolean additionalAccountForAddTest) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        bankAccounts.add(new BankAccount("BNK:3713", 100));
        bankAccounts.add(new CheckingAccount("CHK:5912", 200));
        bankAccounts.add(new SavingsAccount("SAV:9922", 300));
    ...
    {
        return new BankAccount("BNK:2440", 500);
    }
    ...
    private boolean doBankAccountsMatch(BankAccount expected, BankAccount actual) {
        return expected.getClass().getSimpleName().equals(actual.getClass().getSimpleName())
                && expected.getAccountIdentifier().equals(actual.getAccountIdentifier())
