...
public class Step1_TransferFundsTest {
    ...
    public void test03_EdgeCaseTests() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        returnValue = transferFunds.invoke(account1, account2, transferAmount);
        assertEquals(METHOD_NAME + " with a negative transfer amount returned a value different than the Account 1 balance meaning the transfer went through. Account 1 balance: " + balanceAccount1 + ", Account 2 balance: " + balanceAccount2 + ", Transfer: " + transferAmount + ", Return value expected: " + balanceExpected1 + ".",
                balanceExpected1, returnValue);
        ...
        returnValue = transferFunds.invoke(account1, account2, transferAmount);
        assertEquals(METHOD_NAME + " should not allow a transfer if amount exceeds balance. Account 1 balance: " + balanceAccount1 + ", Account 2 balance: " + balanceAccount2 + ", Transfer: " + transferAmount + ", Return value expected: " + balanceExpected1 + ".",
                balanceExpected1, returnValue);
        assertEquals(METHOD_NAME + " should not change the balance for the 'from' account if amount exceeds balance. Account 1 balance: " + balanceAccount1 + ", Account 2 balance: " + balanceAccount2 + ", Transfer: " + transferAmount + ", Account 1 balance expected: " + balanceExpected1 + ".",
                balanceExpected1, account1.getBalance());
        assertEquals(METHOD_NAME + " should not change the balance for the 'to' account if amount exceeds balance. Account 1 balance: " + balanceAccount1 + ", Account 2 balance: " + balanceAccount2 + ", Transfer: " + transferAmount + ", Account 2 balance expected: " + balanceExpected2 + ".",
                balanceExpected2, account2.getBalance());
    }
