...
public class FindAndReplace {
    ...
    public void writeReplacedTextFile(File sourceFile, File destinationFile, String searchTerm, String replacementTerm) throws IOException {
        //
//        if (sourceFile == null || destinationFile == null || searchTerm == null || replacementTerm == null) {
...
//             BufferedWriter writer = new BufferedWriter(new FileWriter(destinationFile))) {
        try (Scanner scanner = new Scanner(sourceFile);
            ...
            while (scanner.hasNextLine()) {
                ...
                if (lineOfInput.contains(searchTerm)) {
                }
                lineOfInput = lineOfInput.replace(searchTerm, replacementTerm);
