...
Create a constructor for this class that accepts four parameters: `int employeeId`, `String firstName`, `String lastName`, and `double annualSalary`. Use these parameters to set the instance variables of the class.
...
| isDoorOpen     | boolean   | X   |     | Whether the elevator door is open or not.       |
