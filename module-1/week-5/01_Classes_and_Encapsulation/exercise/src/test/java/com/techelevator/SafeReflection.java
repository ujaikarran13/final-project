...
public class SafeReflection {
    ...
    /**
     * getField wraps Reflection's getField method so that it either returns the declared field, or null.
     * The field is made accessible to check its value before it is returned.
     *
     * @param klass
     * @param fieldName
     * @return
