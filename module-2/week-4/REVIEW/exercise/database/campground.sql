...
CREATE TABLE site (
  ...
  site_number integer NOT NULL,                   -- Site numbers are not the same as site_id
...
-- The first 5 sites contain a cascade of "diminishing" defaults -- useful for testing the DAO handling of db defaults.
-- Defaults: max_occupancy: 6, accessible: FALSE, max_rv_length: 0, utilities: FALSE
INSERT INTO site (site_number, campground_id) VALUES (1, 1);
-- Defaults:accessible: FALSE, max_rv_length: 0, utilities: FALSE
INSERT INTO site (site_number, campground_id, max_occupancy) VALUES (2, 1, 10);
-- Defaults: max_rv_length: 0, utilities: FALSE
INSERT INTO site (site_number, campground_id, max_occupancy, accessible) VALUES (3, 1, 20, TRUE);
-- Defaults: utilities: FALSE
INSERT INTO site (site_number, campground_id, max_occupancy, accessible, max_rv_length) VALUES (4, 1, 30, TRUE, 40);
-- no defaults
INSERT INTO site (site_number, campground_id, max_occupancy, accessible, max_rv_length, utilities)
    VALUES (5, 1, 40, TRUE, 50, TRUE);
INSERT INTO site (site_number, campground_id, max_occupancy, accessible, max_rv_length, utilities)
    VALUES (6, 1, 40, FALSE, 50, FALSE);
