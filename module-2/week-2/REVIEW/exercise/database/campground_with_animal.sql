...
DROP TABLE IF EXISTS park_animal; 
...
CREATE TABLE animal (
  animal_id serial,
  name varchar(80) NOT NULL,					-- Common name of the animal
  sci_name varchar(80) NOT NULL,			    -- Scientific name of the animal
  CONSTRAINT pk_animal_animal_id PRIMARY KEY (animal_id)
);

CREATE TABLE park_animal (
  park_id INT NOT NULL,               -- id of park where animal is found
  animal_id INT NOT NULL,             -- id of animal found in park
  est_population INT NOT NULL,        -- estimated population of animal within park
...
-- Acadia Blackwoods Sites (RV/Trailer 20ft)
...
-- Acadia Blackwoods Sites (RV/Trailer 35ft)
...
INSERT INTO reservation (site_id, name, from_date, to_date) VALUES (7, 'Aerosmith Reservation', NOW() - INTERVAL '3 days', NOW() + INTERVAL '2 days');
...
-- Animals
INSERT INTO animal (name, sci_name) VALUES ('Largemouth Bass', 'Micropterus salmoides');
INSERT INTO animal (name, sci_name) VALUES ('Moose', 'Alces alces');
INSERT INTO animal (name, sci_name) VALUES ('Coyote', 'Canis latrans');
INSERT INTO animal (name, sci_name) VALUES ('Racoon', 'Porcyon lotor');
INSERT INTO animal (name, sci_name) VALUES ('Great Horned Owl', 'Bubo virginianus');
INSERT INTO animal (name, sci_name) VALUES ('Deer Mouse', 'Peromyscus maniculatus');
INSERT INTO animal (name, sci_name) VALUES ('Bobcat', 'Lynx Rufus');
INSERT INTO animal (name, sci_name) VALUES ('American Toad', 'Anaxyrus americanus');
INSERT INTO animal (name, sci_name) VALUES ('White-Tailed Deer', 'Odocolleus virginianus');
INSERT INTO animal (name, sci_name) VALUES ('Big Brown Bat', 'Eptescius fuscus');
INSERT INTO animal (name, sci_name) VALUES ('Common Snapping Turtle', 'Chelydria serpentina');
INSERT INTO animal (name, sci_name) VALUES ('Brown Snake', 'Storeria dekayi');
INSERT INTO animal (name, sci_name) VALUES ('Black Bear', 'Ursus americanus');

-- Acadia Animals 
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 1, 3000); -- Largemouth Bass
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 2, 10); -- Moose
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 3, 10000); -- Coyote
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 4, 50000); -- Racoon
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 5, 100); -- Great Horned Owl
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 6, 100000); -- Deer Mouse
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 7, 100); -- Bobcat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 9, 20000); -- White-Tailed Deer
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 10, 1000); -- Big Brown Bat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 11, 1000); -- Common Snapping Turtle
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (1, 13, 10); -- Black Bear

-- Arches Animals 
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 1, 1000); -- Largemouth Bass
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 3, 500); -- Coyote
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 4, 1000); -- Racoon
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 5, 100); -- Great Horned Owl
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 6, 10000); -- Deer Mouse
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 7, 10); -- Bobcat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 10, 500); -- Big Brown Bat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (2, 13, 20); -- Black Bear

-- Cuyahoga Animals 
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 1, 10000); -- Largemouth Bass
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 3, 125); -- Coyote
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 4, 1000); -- Racoon
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 5, 200); -- Great Horned Owl
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 6, 1000); -- Deer Mouse
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 7, 1); -- Bobcat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 8, 10000); -- American Toad
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 9, 1200); -- White-Tailed Deer
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 10, 500); -- Big Brown Bat
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 11, 400); -- Common Snapping Turtle
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 12, 3000); -- Brown Snake
INSERT INTO park_animal (park_id, animal_id, est_population) VALUES (3, 13, 30); -- Black Bear
